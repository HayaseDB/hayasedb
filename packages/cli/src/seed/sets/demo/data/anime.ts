...
export const SEED_ANIME: SeedAnime[] = [
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '鬼滅の刃', original: true },
      { locale: 'ja-Latn', title: 'Kimetsu no Yaiba' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '呪術廻戦', original: true },
      { locale: 'ja-Latn', title: 'Jujutsu Kaisen' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'DEATH NOTE', original: true },
      { locale: 'ja-Latn', title: 'DEATH NOTE' },
      {
        locale: 'en',
        title: 'Death Note',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '僕のヒーローアカデミア', original: true },
      { locale: 'ja-Latn', title: 'Boku no Hero Academia' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'HUNTER×HUNTER (2011)', original: true },
      { locale: 'ja-Latn', title: 'HUNTER×HUNTER (2011)' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'ワンパンマン', original: true },
      { locale: 'ja-Latn', title: 'One Punch Man' },
      {
        locale: 'en',
        title: 'One-Punch Man',
        description:
  ...
  },
  {
    ...
    status: 'RELEASING',
    translations: [
      { locale: 'ja-Jpan', title: 'ONE PIECE', original: true },
      { locale: 'ja-Latn', title: 'ONE PIECE' },
      {
        locale: 'en',
        title: 'ONE PIECE',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '東京喰種 トーキョーグール', original: true },
      { locale: 'ja-Latn', title: 'Tokyo Ghoul' },
      {
        locale: 'en',
        title: 'Tokyo Ghoul',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '進撃の巨人 Season２', original: true },
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin Season 2' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'NARUTO -ナルト-', original: true },
      { locale: 'ja-Latn', title: 'NARUTO' },
      {
        locale: 'en',
        title: 'Naruto',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'ソードアート・オンライン', original: true },
      { locale: 'ja-Latn', title: 'Sword Art Online' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Koe no Katachi' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Kimi no Na wa.' },
      {
        locale: 'en',
        title: 'Your Name.',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '進撃の巨人 Season３', original: true },
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin Season 3' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '僕のヒーローアカデミア２', original: true },
      { locale: 'ja-Latn', title: 'Boku no Hero Academia 2' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin: The Final Season' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '約束のネバーランド', original: true },
      { locale: 'ja-Latn', title: 'Yakusoku no Neverland' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'チェンソーマン', original: true },
      { locale: 'ja-Latn', title: 'Chainsaw Man' },
      {
        locale: 'en',
        title: 'Chainsaw Man',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '暗殺教室', original: true },
      { locale: 'ja-Latn', title: 'Ansatsu Kyoushitsu' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'モブサイコ100', original: true },
      { locale: 'ja-Latn', title: 'Mob Psycho 100' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Re:Zero kara Hajimeru Isekai Seikatsu' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        locale: 'ja-Jpan',
        title: '進撃の巨人 Season３ Part.2',
        original: true,
      },
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin Season 3 Part 2' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'NARUTO -ナルト- 疾風伝', original: true },
      { locale: 'ja-Latn', title: 'NARUTO: Shippuuden' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '僕のヒーローアカデミア３', original: true },
      { locale: 'ja-Latn', title: 'Boku no Hero Academia 3' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '鬼滅の刃 無限列車編', original: true },
      { locale: 'ja-Latn', title: 'Kimetsu no Yaiba: Mugen Ressha-hen' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '呪術廻戦 第2期', original: true },
      { locale: 'ja-Latn', title: 'Jujutsu Kaisen 2nd Season' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Cyberpunk: Edgerunners' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '斉木楠雄のΨ難', original: true },
      { locale: 'ja-Latn', title: 'Saiki Kusuo no Ψ-nan' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: 'フリクリ', original: true },
      { locale: 'ja-Latn', title: 'FLCL' },
      {
        locale: 'en',
        title: 'FLCL',
        description:
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '進撃の巨人 OVA', original: true },
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin OVA' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '進撃の巨人 LOST GIRLS', original: true },
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin: LOST GIRLS' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: '進撃！巨人中学校', original: true },
      { locale: 'ja-Latn', title: 'Shingeki! Kyojin Chuugakkou' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      { locale: 'ja-Jpan', title: '薬屋のひとりごと 第3期', original: true },
      { locale: 'ja-Latn', title: 'Kusuriya no Hitorigoto 3rd Season' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'NOT_YET_RELEASED',
    translations: [
      { locale: 'ja-Jpan', title: 'ダンダダン 第3期', original: true },
      { locale: 'ja-Latn', title: 'Dandadan 3rd Season' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        locale: 'ja-Jpan',
        title: '劇場版 陰の実力者になりたくて！ 残響編',
        original: true,
      },
      {
        locale: 'ja-Latn',
        title: 'Kage no Jitsuryokusha ni Naritakute!: Zankyou-hen',
      },
      {
        locale: 'en',
        title: 'The Eminence in Shadow the Movie',
        description:
  ...
  },
  {
    ...
    translations: [
      ...
      { locale: 'ja-Latn', title: 'Shingeki no Kyojin: Chronicle' },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      {
        locale: 'ja-Latn',
        title: 'Shingeki no Kyojin Kouhen: Jiyuu no Tsubasa',
      },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        locale: 'ja-Jpan',
        title: 'ユーリ!!! on ICE 劇場版 : ICE ADOLESCENCE',
        original: true,
      },
      {
        locale: 'ja-Latn',
        title: 'Yuuri!!! on ICE The Movie: ICE ADOLESCENCE',
      },
      {
        locale: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      {
        locale: 'ja-Latn',
        title: 'Shingeki no Kyojin Zenpen: Guren no Yumiya',
      },
      {
        locale: 'en',
  ...
  },
  {
    ...
    status: 'FINISHED',
    translations: [
      { locale: 'ja-Jpan', title: "CHOPPER's", original: true },
      { locale: 'ja-Latn', title: "CHOPPER's" },
      {
        locale: 'en',
        title: "CHOPPER's",
        description:
